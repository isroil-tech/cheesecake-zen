    ...
    <>
      <div className="min-h-screen bg-background pb-32">
        ...
        <div className="flex items-center gap-3 px-5 pt-12 pb-4">
          <button onClick={() => onSuccess()} className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center active-scale shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-foreground"><path d="m12 19-7-7 7-7"/><path d="M19 12H5"/></svg>
          </button>
          <div>
            <h1 className="text-[22px] font-bold text-foreground leadng-none">{t('payment.title')}</h1>
